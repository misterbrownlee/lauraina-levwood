 <?php
  ...
  if ($emailSent) {
    ...
    die ("Sorry, the email system has encountered an error!" .
      "Please return to <a href=\"http://laurainalevwood.com\">laurainalevwood.com</a><br/><br/>");
  }
  ...
  function sendEmail() {
    ...
    $emailTo = "blessingtreebirth@gmail.com";
    $subject = "[lauraina-levwood] message from contact form";
    $headers = "From: do_not_reply@laurainalevwood.com" . "\r\n" .
        "Reply-To: do_not_reply@laurainalevwood.com" . "\r\n" .
        "X-Mailer: PHP/" . phpversion();
  
    $body = createBody();
    
    // send email 
    $success = mail($emailTo, $subject, $body, $headers, "-fdo_not_reply@laurainalevwood.com");
  ...
  function createBody() {
    ...
    $body = "The following was sent from the contact form at laurainalevwood.com";
    $body .= "\n------------------------------------------------\n";
    $body .= "Name: ";
