 <?php
	...
	if ($emailSent) {
		...
		die ("Sorry, the email system has encountered an error!" .
		  "Please return to <a href=\"http://lauraina.levwood.com\">laurainalevwood.com</a><br/><br/>");
	}
	...
	function sendEmail() {
		...
		$emailTo = "aaron.brownlee@gmail.com";
		$subject = "[TEST-lauraina-levwood] message from TEST contact form";
	...
	function createBody() {
		...
		$body = "The following was sent from the TEST contact form at tehfoo.com/lauraina.levwood";
		$body .= "\n------------------------------------------------\n";
		$body .= "Name: ";
